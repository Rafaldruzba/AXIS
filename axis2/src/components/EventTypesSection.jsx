...
export default function EventTypesSection() {
	return (
		// ZMIANA 1: Główne tło sekcji na czarne (ciemny grafit)
		<section className='py-32 bg-black'>
			<div className='max-w-7xl mx-auto px-6'>
				...
				<div className='flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-8'>
					...
					{/* ZMIANA 3: Tekst opisu na jasny gray-400, żeby był czytelny ale nie tak jaskrawy jak biały */}
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
					{' '}
					{/* Dodałem responsywny grid dla lepszego widoku na mobile */}
					{EventsType.map((event, index) => (
						<Link
							...
							{/* 2. NOWOŚĆ: Warstwa przyciemniająca CAŁOŚĆ po najechaniu (overlay) */}
							{/* Domyślnie niewidoczna (opacity-0), na hover robi się ciemno (np. opacity-50) */}
